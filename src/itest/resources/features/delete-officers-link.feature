Feature: Delete officers link in company profile

  Scenario Outline: Delete officers link successfully
    ...
    When  a PATCH request is sent to the delete officers link endpoint for "<company_number>"
  ...
  Scenario Outline: Delete officers link unsuccessfully - user not authenticated or authorised

    When  a PATCH request is sent to the delete officers endpoint for "<company_number>" without ERIC headers
  ...
  Scenario Outline: Delete officers link unsuccessfully - link already does not exist
