...
class CompanyProfileServiceTest {
    ...
    void addExemptionsLink() throws ApiErrorResponseException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        // given
        ...
        // when
        companyProfileService.processLinkRequest(exemptionsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, false);
    ...
    void addExemptionsLinkNotFound() {
        ...
        // when
        Executable executable = () -> companyProfileService
                .processLinkRequest(exemptionsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, false);
    ...
    void deleteExemptionsLink() throws ApiErrorResponseException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        // given
        when(companyProfileRepository.findById(any())).thenReturn(Optional.of(document));
        when(document.getCompanyProfile()).thenReturn(data);
        when(data.getLinks()).thenReturn(links);
        ...
        // when
        companyProfileService.processLinkRequest(exemptionsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, true);
    ...
    void deleteExemptionsLinkNotFound() {
        ...
        // when
        Executable executable = () -> companyProfileService
                .processLinkRequest(exemptionsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, true);
    ...
    void addOfficersLink() throws ApiErrorResponseException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        // given
        when(companyProfileRepository.findById(any())).thenReturn(Optional.of(document));
        when(document.getCompanyProfile()).thenReturn(data);
        when(data.getLinks()).thenReturn(links);
        ...
        // when
        companyProfileService.processLinkRequest(officersLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, false);
    ...
    void addOfficersLinkNotFound() {
        ...
        // when
        Executable executable = () -> companyProfileService
                .processLinkRequest(officersLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, false);
        // then
        Exception exception = assertThrows(DocumentNotFoundException.class, executable);
        assertEquals(String.format("No company profile with company number %s found", MOCK_COMPANY_NUMBER), exception.getMessage());
        verify(companyProfileRepository).findById(MOCK_COMPANY_NUMBER);
    ...
    void deleteOfficersLink() throws ApiErrorResponseException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        // given
        when(companyProfileRepository.findById(any())).thenReturn(Optional.of(document));
        when(document.getCompanyProfile()).thenReturn(data);
        when(data.getLinks()).thenReturn(links);
        ...
        // when
        companyProfileService.processLinkRequest(officersLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, true);
        // then
        verify(companyProfileRepository).findById(MOCK_COMPANY_NUMBER);
        verify(companyProfileApiService).invokeChsKafkaApi(MOCK_CONTEXT_ID, MOCK_COMPANY_NUMBER);
    }
    ...
    void deleteOfficersLinkNotFound() {
        ...
        // when
        Executable executable = () -> companyProfileService
                .processLinkRequest(officersLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, true);
        // then
        Exception exception = assertThrows(DocumentNotFoundException.class, executable);
        assertEquals(String.format("No company profile with company number %s found", MOCK_COMPANY_NUMBER), exception.getMessage());
        verify(companyProfileRepository).findById(MOCK_COMPANY_NUMBER);
    ...
    void addPscStatementsLink() throws ApiErrorResponseException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        // given
        when(companyProfileRepository.findById(any())).thenReturn(Optional.of(document));
        when(document.getCompanyProfile()).thenReturn(data);
        when(data.getLinks()).thenReturn(links);
        ...
        // when
        companyProfileService.processLinkRequest(pscStatementsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, false);
        // then
        verify(companyProfileRepository).findById(MOCK_COMPANY_NUMBER);
        verify(companyProfileApiService).invokeChsKafkaApi(MOCK_CONTEXT_ID, MOCK_COMPANY_NUMBER);
    }
    ...
    void addPscStatementsLinkNotFound() {
        ...
        // when
        Executable executable = () -> companyProfileService
                .processLinkRequest(pscStatementsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, false);
    ...
    void deletePscStatementsLink() throws ApiErrorResponseException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        // given
        when(companyProfileRepository.findById(any())).thenReturn(Optional.of(document));
        when(document.getCompanyProfile()).thenReturn(data);
        when(data.getLinks()).thenReturn(links);
        ...
        // when
        companyProfileService.processLinkRequest(pscStatementsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, true);
    ...
    void deletePscStatementsLinkNotFound() {
        ...
        // when
        Executable executable = () -> companyProfileService
                .processLinkRequest(pscStatementsLinkType, MOCK_COMPANY_NUMBER, MOCK_CONTEXT_ID, true);
