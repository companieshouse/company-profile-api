...
public class CompanyProfileController {
    ...
    public ResponseEntity<Void> deleteCompanyProfile(
        ...
        try {
            ...
            logger.error("Error while trying to delete company profile: " + resourceNotFoundException.getMessage());
            return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
        } catch (DataAccessException dataAccessException) {
            logger.error("Error while trying to delete company profile: " + dataAccessException.getMessage());
