...
public class UkEstablishmentAddressMapper {
    ...
    public static PrivateUkEstablishmentsAddressApi mapToUkEstablishmentAddress(VersionedCompanyProfileDocument versionedCompanyProfileDocument) {
        ...
        RegisteredOfficeAddressApi registeredOfficeAddressApi = RegisteredOfficeAddressMapper.mapToApi(versionedCompanyProfileDocument.getCompanyProfile().getRegisteredOfficeAddress());
